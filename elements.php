...
<div class="super_container">
						...
						<div class="header_content d-flex flex-row align-items-center justify-content-start">
							...
							<nav class="main_nav_contaner ml-auto">
								<ul class="main_nav">
									...
									<li><a href="programs.php">courses</a></li>
									<li><a href="page-details.php">news</a></li>
	...
	<div class="menu d-flex flex-column align-items-end justify-content-start text-right menu_mm trans_400">
		...
		<nav class="menu_nav">
			<ul class="menu_mm">
				...
				<li class="menu_mm"><a href="programs.php">Courses</a></li>
	...
	<div class="elements">
								...
								<div class="tab_panels">
									<div class="tab_panel">
										<div class="tab_panel_content">
											<div class="row">
												<div class="col-lg-6">
													<div class="tab_image"><img src="assets/images/tab.jpg" alt=""></div>
												</div>
												<div class="col-lg-6">
		...
		<div class="milestones">
			...
			<div class="milestones_background" style="background-image:url(assets/images/milestones.jpg)"></div>
			<div class="container">
			...
			<div class="container">
				...
				<div class="row icon_boxes_row">
					...
					<div class="col-lg-4 ib_col">
						<div class="icon_box">
							<div class="ib_title_container d-flex flex-row align-items-center justify-content-start">
								<div class="ib_image"><img src="assets/images/icon_1.png" alt=""></div>
					...
					<div class="col-lg-4 ib_col">
						<div class="icon_box">
							<div class="ib_title_container d-flex flex-row align-items-center justify-content-start">
								<div class="ib_image"><img src="assets/images/icon_2.png" alt=""></div>
					...
					<div class="col-lg-4 ib_col">
						<div class="icon_box">
							<div class="ib_title_container d-flex flex-row align-items-center justify-content-start">
								<div class="ib_image"><img src="assets/images/icon_3.png" alt=""></div>
					...
					<div class="footer_contact">
						...
						<div class="footer_contact_info">
							<div class="footer_contact_item">
								...
								<div class="footer_contact_line">Iraq - Maysan, Amarah</div>
							</div>
							<div class="footer_contact_item">
								<div class="footer_contact_title">Phone:</div>
								<div class="footer_contact_line">+964 782 227 8550</div>
							</div>
							<div class="footer_contact_item">
								<div class="footer_contact_title">Email:</div>
								<div class="footer_contact_line">alwrqa.org@gmail.com</div>
							</div>
						</div>
					</div>
				</div>
